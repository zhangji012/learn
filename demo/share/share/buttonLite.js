var BSHARE_SHOST_NAME = "./share", BSHARE_BUTTON_HOST = "./share",
...
(function (e, g, l) {
  ...
  if (!(h.count > 0)) {
    ...
    a.loadButtonStyle = function () {
      if (c.type != 15) {
        var f, e = b.style;
        if (b.beta) f = a.jsBasePath + "styles/bshareS888.js?v=20180226"; else if (b.popjs) f = b.popjs; else if (b.style != -1 && (f = a.jsBasePath + "styles/bshareS" + (e > 1 && e < 6 ? e : 1) + ".js?v=20180226", b.pop == -1 && (e <= 1 || e >= 6))) f = "";
        f && d.loadScript(f)
      }
    };
    a.international =
